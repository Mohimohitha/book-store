...
function Uhome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-20">
      <header className="bg-white shadow-sm border-b px-8 py-6 mb-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div>
          <h1 className="text-4xl font-serif font-bold text-gray-900 tracking-tight">BooksWorld</h1>
          <p className="text-sm text-gray-500 mt-1">Curated selections for the discerning reader.</p>
        </div>
        <div className="flex gap-4 w-full sm:w-auto">
          <input type="text" placeholder="Search titles or authors..." className="border border-gray-300 px-4 py-2 rounded-md text-sm w-full sm:w-72 focus:outline-none focus:ring-2 focus:ring-gray-900" />
          <button className="bg-gray-900 text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-gray-800 transition whitespace-nowrap">Cart (0)</button>
        </div>
      </header>
